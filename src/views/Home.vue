...
<!-- muestra de los cursos disponibles-->
      <div class="jumbotron">
        <div class="container">
          ...
          <p>Descubre un amplio contenido de formación gratuita para impulsar tu negocio o carrera profesional. 
        Aprende todo lo que necesites seleccionando módulos para explorar y aprender</p>
